...
install.packages (c("foreign", "ggplot", "dplyr","car", "performance", stargazer", "lme4", "sandwich", "corrplot"))
...
La prevalencia de violencia es similar en áreas urbanas y rurales, aunque ligeramente mayor en el campo. Esto sugiere que la violencia no es un fenómeno exclusivo de un contexto geográfico, sino que aparece en ambas áreas.
...
## Pruebas
```{r}
qqmath(ranef(jerarquico2, condVar = TRUE))
```
