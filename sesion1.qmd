...
install.packages (c("readr", "dplyr","summarytools","performance","lme4"))
...
Podríamos hacer un modelo agrupando por sexo?. Los datos de las notas promedio por sexo son los siguientes:
